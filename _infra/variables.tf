variable "availability_zones" {
  ...
  default     = ["us-east-1a"] # ADD back in for HA => , "us-east-1b", "us-east-1c"
}
...
variable "public_subnets" {
  ...
  default     = ["10.0.16.0/20"] # ADD back in for HA => , "10.0.48.0/20", "10.0.80.0/20"
}
...
variable "private_subnets" {
  ...
  default     = ["10.0.0.0/20"] # ADD back in for HA => , "10.0.32.0/20", "10.0.64.0/20"
}
